...
import { handleInboundProcurementEmailWebhook } from "../../lib/inbound-procurement-email-handler.js";
...
export default async function handler(
  ...
  try {
    ...
    console.error("Inbound procurement email webhook error:", message);
