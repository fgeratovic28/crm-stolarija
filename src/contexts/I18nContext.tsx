...
const sr: Dictionary = {
  ...
  "nav.materialReception": "Prijem materijala",
  ...
  "settings.invoicing.jobNumberFormat": "Format broja posla",
  "settings.invoicing.jobNumberFormatLegacy": "Stari (prefiks + godina + redni), npr. PO2026-055",
  "settings.invoicing.jobNumberFormatNumeric": "Novi (samo cifre), npr. 226246",
  "settings.invoicing.jobNumberFormatHint": "Podrazumevano ostaje stari format dok ne izaberete novi i sačuvate.",
  "settings.invoicing.jobPrefix": "Prefiks posla",
  "settings.invoicing.jobPrefixHint": "Samo slova (npr. PO).",
  "settings.invoicing.jobNextSeqLegacy": "Sledeći redni broj (deo posle godine)",
  "settings.invoicing.jobNextSeqLegacyHint": "Samo cifre. Svaki novi posao uvećava za 1.",
  "settings.invoicing.jobNextNumber": "Broj sledećeg posla",
  "settings.invoicing.jobNextNumberHint": "Samo cifre (npr. 226246). Svaki novi posao uvećava za 1.",
  ...
  "settings.toasts.jobPrefixInvalid": "Prefiks posla mora sadržati bar jedno slovo (bez cifara).",
  "settings.toasts.jobNextNumberInvalid": "Broj posla mora biti pozitivan ceo broj (samo cifre).",
  "settings.toasts.jobCounterSaveError": "Podešavanja su sačuvana, ali brojač poslova nije ažuriran.",
  ...
  "maintenance.description":
    "Ne možete da koristite aplikaciju. Imate neizmireno dugovanje. Dugovanje na današnji dan iznosi: 7.245,65 RSD.",
...
const en: Dictionary = {
  ...
  "nav.materialReception": "Material Reception",
  ...
  "settings.invoicing.jobNumberFormat": "Job number format",
  "settings.invoicing.jobNumberFormatLegacy": "Legacy (prefix + year + sequence), e.g. PO2026-055",
  "settings.invoicing.jobNumberFormatNumeric": "Numeric only, e.g. 226246",
  "settings.invoicing.jobNumberFormatHint": "Legacy stays active until you choose numeric and save.",
  "settings.invoicing.jobPrefix": "Job prefix",
  "settings.invoicing.jobPrefixHint": "Letters only (e.g. PO).",
  "settings.invoicing.jobNextSeqLegacy": "Next sequence number (after year)",
  "settings.invoicing.jobNextSeqLegacyHint": "Digits only. Each new job increments by 1.",
  "settings.invoicing.jobNextNumber": "Next job number",
  "settings.invoicing.jobNextNumberHint": "Digits only (e.g. 226246). Each new job increments by 1.",
  ...
  "settings.toasts.jobPrefixInvalid": "Job prefix must contain at least one letter (no digits).",
  "settings.toasts.jobNextNumberInvalid": "Job number must be a positive whole number (digits only).",
  "settings.toasts.jobCounterSaveError": "Settings were saved, but the job counter could not be updated.",
  ...
  "maintenance.description":
    "You cannot use the application. You have an outstanding balance. Today's balance: 7,245.65 RSD.",
