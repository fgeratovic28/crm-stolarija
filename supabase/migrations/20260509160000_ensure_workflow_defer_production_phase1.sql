-- Faza 1: ne kreirati automatski RN proizvodnje. Posle potvrde na poslu (status -> zakazano) kreira se RN ugradnje
-- i kada je merenje ok a nema nijednog RN proizvodnje (proizvodnja van CRM).
...
BEGIN
  ...
  -- Faza 1: automatski RN proizvodnje je iskljucen (proizvodnja van CRM). U fazi 2 vratiti INSERT ispod.
