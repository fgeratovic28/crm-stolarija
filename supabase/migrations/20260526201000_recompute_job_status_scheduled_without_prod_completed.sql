-- Zakazivanje ugradnje: status posla ne sme da padne u „U proizvodnji“ samo zato što RN proizvodnje
-- još nije označen kao završen u bazi, dok postoji RN ugradnje i svi su „pending“.
-- Stari v_scheduled je zahtevao v_prod_done_effective i za (has_inst AND install_all_pending),
-- pa je v_scheduled postajao false → v_in_production true posle recompute_job_status.
