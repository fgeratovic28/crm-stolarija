-- `recompute_job_status`: posle završene montaže i završnog terenskog izveštaja — ako ima duga, status „Ugradnja završena / nije plaćeno“, inače „Završen“.
...
SET status = 'installation_done_unpaid'::public.job_status
WHERE j.status = 'installation_in_progress'::public.job_status
  AND (
