-- Ako ensure_workflow_work_orders baci grešku (INSERT RN, konflikt, nedostajuća funkcija),
-- ceo recompute_job_status je ranije pucao i status posla se nije menjao.
-- Osiguraj: prvo ažuriraj status posla kad treba, zatim pozovi ensure u zaštićenom bloku.
