-- Naknadni patch (idempotentno): vrednost enuma `final_quote_accepted_pending_payment` i
-- ista logika `recompute_job_status` kao u 20260518110000. Potrebno ako je starija verzija
-- migracije 20260518110000 već primenjena bez novog statusa.
