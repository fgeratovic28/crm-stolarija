-- FAZA 1: proširenje statusa poslova za CRM/ERP tok stolarije.
-- Napomena: ne menja postojeći auth/session flow niti postojeće automatizacije;
-- proširuje enum i čuva postojeća pravila automatskog prelaza.

ALTER TYPE public.job_status ADD VALUE IF NOT EXISTS 'accepted';
ALTER TYPE public.job_status ADD VALUE IF NOT EXISTS 'ready_for_work';
ALTER TYPE public.job_status ADD VALUE IF NOT EXISTS 'waiting_material';
