-- Javna narudžbenica: način isporuke sa dobavljača ako na porudžbini nije upisan
...
AS $$
  SELECT jsonb_build_object(
    ...
    'nbShippingMethod', COALESCE(NULLIF(TRIM(mo.nb_shipping_method), ''), NULLIF(TRIM(s.nb_shipping_method), '')),
