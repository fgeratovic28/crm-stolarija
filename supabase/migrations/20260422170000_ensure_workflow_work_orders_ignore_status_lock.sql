-- Zaključavanje statusa posla (status_locked) treba da spreči automatsku PROMENU statusa u recompute_job_status,
-- a ne kreiranje radnih naloga u ensure_workflow_work_orders. Uklanja se rani RETURN na v_locked.
