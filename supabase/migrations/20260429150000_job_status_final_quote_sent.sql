-- Status posla posle slanja finalne ponude klijentu (iz faze obrade mera posle merenja).

ALTER TYPE public.job_status ADD VALUE IF NOT EXISTS 'final_quote_sent';
