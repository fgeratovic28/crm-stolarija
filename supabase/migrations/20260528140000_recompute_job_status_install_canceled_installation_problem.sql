-- RN ugradnje otkazan u UI: v_install_all_pending je ranije tretirao „canceled“ kao „nije pending“,
-- pa v_scheduled padne i posao ode u „U proizvodnji“. Sada se otkazani RN ignorišu za „svi pending“,
-- a ako nema otvorenog RN ugradnje ali postoji otkazan — status „Ugradnja – problem“.
...
BEGIN
  ...
  -- Aktivni RN ugradnje (ne otkazani, ne završeni): svi moraju biti „pending“ da bi posao bio „Čeka ugradnju“.
  ...
  -- Čeka ugradnju: svi RN ugradnje su pending čim je merena faza gotova — ne čekati zatvaranje RN proizvodnje.
  -- Staza bez ugradnje i sa RN proizvodnjom i dalje zahteva završenu proizvodnju.
  v_scheduled :=
    v_meas_phase_done
    AND (
