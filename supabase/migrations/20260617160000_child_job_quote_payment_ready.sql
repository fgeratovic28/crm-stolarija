-- Pod-posao: prihvat + uplata -> spremno za rad; bez statusa finalne ponude u toku deteta.
...
BEGIN
  ...
  ELSIF v_parent_job_id IS NOT NULL AND v_ready_for_work_ok AND v_has_accepted_quote THEN
