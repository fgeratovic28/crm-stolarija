-- Prioritet: postoji otkazan RN ugradnje i nema ugradnje u toku → „Ugradnja – problem“,
-- čak i kad `ensure_workflow` ostavi novi `pending` prateći nalog (inače bi `v_scheduled` dao „Čeka ugradnju“).
