-- Osigurava RN (merenje/proizvodnja/ugradnja) u istoj DB sesiji kao recompute statusa posla.
-- Rešava slučaj kada je status posla već „U proizvodnji“, a klijentski poziv ensure_workflow_work_orders
-- ne kreira RN (mreža, RLS na drugom pozivu, keš).
...
BEGIN
  ...
  -- Isti zahtev kao klijent: kreiraj sledeće RN dok su work_orders + field_reports već u bazi.
  PERFORM public.ensure_workflow_work_orders(p_job_id);
