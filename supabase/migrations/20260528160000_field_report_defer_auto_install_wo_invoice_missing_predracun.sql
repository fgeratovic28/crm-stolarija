-- Prijava „nedostaje sa predračuna“ (modal): ne kreirati odmah novi RN ugradnje iz `apply_field_report_workflow_branching`.
-- RN za ponovno zakazivanje ostaje na akcijama sa dashboarda (Nabavka / „Zaboravljeno u magacinu“) preko postojećih RPC-ova.
...
COMMENT ON FUNCTION public.apply_field_report_workflow_branching(uuid) IS
  'Grananje terenskog izveštaja. Za flag invoiceMissingDeferAutoInstallationWo u details, ne otvara odmah novi RN ugradnje (prijava sa predračuna — triage na dashboardu).';
