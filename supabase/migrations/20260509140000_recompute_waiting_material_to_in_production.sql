-- Kada je sav materijal primljen, posao na „Čeka materijal“ mora preći u „U proizvodnji“.
-- Ranije je grananje na „Zakazano“ (v_scheduled: ugradnja svi pending bez RN proizvodnje) dolazilo pre
-- opšte grane v_in_production, a v_in_production je sadržao AND NOT v_scheduled — pa je status ostajao pogrešan.
