-- Ponude su PDF + ukupan iznos; stavke više nisu u upotrebi.
-- Skraćuje se obuhvat RN opisa (samo `jobs.summary`) i brišu tabele `quote_lines` i `job_quote_lines`.
...
DROP TABLE IF EXISTS public.job_quote_lines CASCADE;
