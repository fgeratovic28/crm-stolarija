-- U opisu novo-otvorenog RN za ponovo zakazivanje (site_canceled za merenje/proveru/ugradnju)
-- nemoj dopisivati [AUTO] „Prethodni nalog…“ — ostaje konkretni sadržaj (razlog/stavke/izveštaj) ili prazno.
...
COMMENT ON FUNCTION public.apply_field_report_workflow_branching(uuid) IS
  'Grananje terenskog izveštaja. Ponovo zakazivanje posle site_canceled: opis novo-RN bez [AUTO] zaglavlja; ostala logika kao ranije.';
