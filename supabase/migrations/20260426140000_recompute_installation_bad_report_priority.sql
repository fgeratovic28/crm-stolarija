-- Problem: loš završni izveštaj na ugradnji (everything_ok = false) treba uvek da postavi
-- installation_problem (prvi ciklus, pre first_completed_at), čak i kada postoji drugi
-- otvoreni RN tipa ugradnje — inače v_inst_job_done bude false i status padne u in_production.
-- Ujedno: inst_job_done nakon toga samo "Završen" (loš slučaj rešen gore); uklonjen grešan prelaz u complaint
-- iz 20260426125500.
