-- Sivi baner: RN reklamacije i servisa bez dodeljenog tima (uz postojeće tipove).
...
COMMENT ON FUNCTION public.list_work_orders_missing_team_for_dashboard() IS
  'Dashboard: RN bez tima (merenje, ugradnja, proizvodnja, reklamacija, servis); merenje za Prihvaćeno/Merenje u drugom RPC-u.';
